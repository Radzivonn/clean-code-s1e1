...
var incompleteTaskHolder = document.querySelector(".incomplete-tasks-block"); //ul of #incompleteTasks
var completedTasksHolder = document.querySelector(".completed-tasks-block"); //completed-tasks
